...
RSpec.feature "user creates a playlist" do
  scenario "they see the page for an individual playlist" do
    song_one, song_two, song_three = create_list(:song, 3)

    playlist_name = "Jamzzz"
    ...
    find(:button, "Create Playlist").click

    expect(current_path).to eq playlist_path(Playlist.first)
